...
export const setDefaults = (
  ...
  return {
    ...
    header: {
      ...
      textSize: options.header?.textSize ?? 15, // Set default header text size or use provided value
    ...
    pageMargin: {
      bottom: options.pageMargin?.bottom ?? 5, // Set default page margin bottom or use provided value
      right: options.pageMargin?.right ?? 50, // Set default page margin right or use provided value
    },
    contentMargin: {
      horizontal: options.contentMargin?.horizontal ?? 2, // Set default content margin horizontal or use provided value
